CREATE DATABASE IF NOT EXISTS isucon_practice;
USE isucon_practice;
...
INSERT INTO items (id, name, description, price, category)
SELECT seq, CONCAT('Item ', seq), CONCAT('Desc ', seq), FLOOR(RAND()*10000),
       ELT((seq % 4)+1, 'Electronics','Food','Clothing','Books')
FROM (
